...
import pdb
from Mod_channel_att import Mod_channel_module
...
class BottleNeck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, spatial=False, channel=False):
        ...
        #self.mod_channel_moduel = Mod_channel_module(planes*4, 16)
        #self.mod_channel = mod_channel
        self.att_module = CBAM_module(planes*4, 16, channel=channel, spatial=spatial)
...
class ResNet(nn.Module): 
    ...
    def _make_layer(self, num_block, planes, stride=1):
        ...
        for now_stride in strides:
            #breakpoint()
            #print(self.channel, self.spatial) 
            layers.append(
                self.block(
...
def res101_CBAM(
    ...
    if pretrain and pretrained_model != "":
        ...
        print("Choose to train from scratch R101")
    return resnet
